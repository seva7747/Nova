const STACK = [
  {
    ...
    why: "Always-on, free, and runs locally in the tab listening for “Nova” — no API call happens until it fires.",
  },
  {
    stage: "Listening & speaking",
    choice: "OpenAI · GPT-Live-1",
    why: "One persistent, full-duplex WebRTC voice session — replaces separate transcription and text-to-speech calls with a single always-on connection. It carries audio only, and never answers on its own.",
  },
  {
    stage: "Thinking & tool routing",
    choice: "OpenAI · GPT-5.4-mini",
    why: "GPT-Live-1 delegates every real request here — a separate model, on a separate API call. Fast, cheap, and reliable at deciding which tool to call (Gmail, Calendar, web search...).",
  },
  {
    stage: "Live info",
    choice: "OpenAI's hosted web search",
